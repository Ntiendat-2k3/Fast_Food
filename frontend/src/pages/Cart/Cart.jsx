...
const Cart = () => {
  const { cartItems, food_list, removeFromCartAll, getTotalCartAmount, url } = useContext(StoreContext)
                    ...
                    if (cartItems[item.name] > 0) {
                      return (
                        <tr key={index} className="border-b border-gray-200 dark:border-dark-lighter">
                          ...
                          <td className="py-4 text-gray-600 dark:text-gray-300">{cartItems[item.name]}</td>
                ...
                <div className="space-y-3">
                  ...
                  <div className="border-t border-gray-300 dark:border-dark-lighter pt-3 flex justify-between">
                    ...
                    <span className="text-lg font-bold text-primary">
                      {(getTotalCartAmount() === 0 ? 0 : getTotalCartAmount() + 14000).toLocaleString("vi-VN")} đ
                    </span>
                  </div>
                </div>
                <button
